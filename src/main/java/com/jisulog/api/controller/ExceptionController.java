...
import com.jisulog.api.exception.JisulogException;
import com.jisulog.api.response.ErrorResponse;
...
public class ExceptionController {
    ...
    @ExceptionHandler(JisulogException.class)
    @ResponseBody
    public ResponseEntity<ErrorResponse> jisulogException(JisulogException e) {
